...
return [
    ...
    'signal_room' => [
        ...
        'tab_content' => [
            'checks_title' => 'Check details',
            'checks_description' => 'The key measurements from the latest check.',
            'incidents_title' => 'Incident status',
            'incidents_description' => 'Open incidents and the current action needed for this monitoring.',
            'history_title' => 'Check history',
            'history_description' => 'The latest known state for this monitoring.',
        ],
