...
return [
    'seo' => [
        ...
        'description' => 'WebGuard is free-to-use monitoring software for HTTP, Ping, Keyword, Port, Heartbeat, Server Health, DNS record, SSL, and domain expiry checks with monitoring groups, integrations, SLA badges, configurable alerts, weekly digests, uptime insights, and public status pages.',
        'keywords' => 'free monitoring software, uptime monitoring, website monitoring, monitoring groups, server health monitoring, CPU monitoring, RAM monitoring, storage monitoring, DNS record monitoring, expected HTTP status codes, ping monitoring, keyword monitoring, port monitoring, heartbeat monitoring, cronjob monitoring, weekly monitoring digest, SLA badge, REST API monitoring, SSL expiry monitoring, domain expiry monitoring, status page, incident alerts',
    ...
    'hero' => [
        ...
        'legacy_badge_copy' => 'compact SLA badge',
        'metrics' => [
            '1' => [
                'label' => 'License',
