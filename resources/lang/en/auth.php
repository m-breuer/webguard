...
return [
    ...
    'register' => [
        ...
        'captcha_image_alt' => 'Security check image',
        'captcha_reload' => 'Reload',
        'captcha_required' => 'Please enter the security check.',
        'captcha_invalid' => 'The security check was incorrect. Please try again.',
        'button' => 'Register',
