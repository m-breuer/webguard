...
return [
    ...
    'form' => [
        ...
        'notification_on_failure_enabled' => 'Send notifications if this monitoring fails',
        ...
        'ssl_expiry_warning_days' => 'SSL warning window (days)',
        'ssl_expiry_warning_days_help' => 'SSL notifications are sent when the certificate expires within this window.',
