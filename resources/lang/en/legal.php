        ...
        'sections' => [
            'scope' => [
                ...
                'items' => [
                    ...
                    'Public status labels and an embeddable public widget when enabled by the user.',
            ...
            'obligations' => [
                ...
                'items' => [
                    ...
                    'Protect credentials, API tokens, heartbeat ping URLs, webhook URLs, bot tokens, and optional authentication data used in checks.',
                    ...
                    'When enabling public labels or public widgets, ensure no confidential information is exposed in monitoring names, target URLs, status data, or embedded displays.',
                ],
            ],
            'liability' => [
