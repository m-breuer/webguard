...
return [
    ...
    'detail' => [
        ...
        'server_health' => [
            ...
            'load_threshold' => 'Load-Schwelle pro CPU',
            'service_response_time_threshold' => 'Antwortzeit-Schwelle für Dienste',
            'report_interval' => 'Erwartetes Report-Intervall',
            'grace' => 'Kulanzzeit',
            'minutes' => ':count Minute|:count Minuten',
            'current_metrics' => 'Aktuelle Server-Metriken',
            'history' => 'Telemetrieverlauf',
            'history_help' => 'Durchschnittliche gemeldete Hostmetriken im ausgewählten Zeitraum.',
            'history_loading' => 'Telemetrieverlauf wird geladen ...',
            'cpu_usage' => 'CPU-Auslastung',
            'ram_usage' => 'RAM-Auslastung',
            'storage_usage' => 'Speicherauslastung',
            'normalized_load' => 'Last pro CPU',
            'percent_axis' => 'Auslastung (%)',
            'load_axis' => 'Last pro CPU',
            'threshold' => 'Schwelle',
            'cpu' => 'CPU',
            'ram' => 'RAM',
            'load' => 'Load (1 Minute)',
            'uptime' => 'Uptime (Sekunden)',
            'service_checks' => ':count lokaler Service-Check konfiguriert|:count lokale Service-Checks konfiguriert',
        ],
        'domain' => [
    ...
    'form' => [
        ...
        'server_health_help' => 'WebGuard erzeugt für diesen Monitor einen privaten API-Endpunkt. Senden Sie CPU-, RAM-, Load-, Uptime- und optionale lokale Service-Check-Ergebnisse von Ihrem Server-Agent oder Cron-Skript.',
        ...
        'server_health_thresholds_help' => 'Reports werden als nicht verfügbar markiert, wenn CPU- oder RAM-Auslastung, normalisierte Load oder ein lokaler Service-Check die konfigurierte Fehlerschwelle erreicht.',
        ...
        'server_health_load_threshold_per_cpu' => 'Load-Schwelle pro CPU',
        'server_health_service_response_time_threshold_ms' => 'Schwelle für beeinträchtigte Service-Antwortzeit (ms)',
        'server_health_report_interval_minutes' => 'Erwartetes Report-Intervall (Minuten)',
        'server_health_grace_minutes' => 'Kulanzzeit für Reports (Minuten)',
        'placeholders' => [
    ...
    'actions' => [
        ...
        'edit' => 'Bearbeiten',
        'server_health_token' => [
            'rotate' => 'Melde-URL rotieren',
            'rotate_confirmation' => 'Melde-URL rotieren? Der aktuell konfigurierte Server-Agent kann erst wieder melden, wenn er die neue URL verwendet.',
        ],
        'reset' => [
    ...
    'messages' => [
        ...
        'server_health_token_rotated' => 'Server-Zustand-Melde-URL rotiert. Aktualisieren Sie die Agent-Konfiguration mit der neuen URL.',
