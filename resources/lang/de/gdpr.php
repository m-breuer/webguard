    ...
    'sections' => [
        ...
        'data_categories' => [
            ...
            'items' => [
                ...
                'Monitoring-Konfigurationsdaten (Name, Monitoring-Typ, Zieladresse, Port, Keyword, DNS-Eintragserwartungen, HTTP-Methode, erwartete HTTP-Statuscodes, Header/Body, optionale Zugangsdaten, bevorzugte Standorte, Wartungsfenster, Public-Label-Einstellung, Heartbeat-Intervall, Kulanzzeit und private Heartbeat-Ping-URL bzw. Token).',
                ...
                'Öffentlich freigegebene Statusdaten, wenn Public Labels oder SLA-Badges aktiviert sind (z. B. Monitoring-Name, aktueller Status, Uptime-Kennzahlen und Wartungsstatus).',
        ...
        'purposes_legal_basis' => [
            ...
            'purposes' => [
                ...
                'Bereitstellung öffentlicher Status-Labels und SLA-Badges, wenn Nutzer diese Funktion aktivieren.',
