...
return [
    ...
    'detail' => [
        'back' => 'Statusseiten',
        'summary' => 'Statusseiten-Kontext',
        'published' => 'Veröffentlicht',
        'draft' => 'Nicht veröffentlicht',
        'owner' => 'Verantwortlich',
        'components' => 'Komponenten',
        'incidents' => 'Vorfälle im Zeitraum',
        'public_url' => 'Öffentliche URL',
        'open_public_page' => 'Öffentliche Seite öffnen',
        'incident_context' => 'Vorfallkontext',
        'root_cause' => 'Ursache',
        'request_response' => 'Prüfkontext',
        'regions_activity' => 'Regionen und Aktivität',
    ],
    'empty' => [
