...
return [
    ...
    'signal_room' => [
        ...
        'all_under_control' => 'Alle Systeme unter Kontrolle',
        'attention_summary' => ':count Bereich braucht Aufmerksamkeit|:count Bereiche brauchen Aufmerksamkeit',
        'updated' => 'Gerade eben aktualisiert',
        'add_service' => 'Service hinzufügen',
        'search_placeholder' => 'Services, Gruppen oder Incidents suchen',
        'filters' => [
            'all' => 'Alle',
        ...
        'service_landscape' => 'Service-Landkarte',
        'active_services' => 'Services',
        'target' => 'Ziel',
        'last_check' => 'Letzter Check',
        'no_check' => 'Noch kein Check',
        'ungrouped' => 'Nicht zugeordnet',
        'tabs' => [
            'signal' => 'Signal',
            'checks' => 'Checks',
            'incidents' => 'Incidents',
        ...
        'tabs_label' => 'Monitoring-Details',
        'tab_content' => [
            'checks_title' => 'Prüfdetails',
            'checks_description' => 'Die wichtigsten Messwerte der letzten Prüfung.',
            'incidents_title' => 'Incident-Status',
            'incidents_description' => 'Offene Vorfälle und der aktuelle Handlungsbedarf für dieses Monitoring.',
            'history_title' => 'Prüfverlauf',
            'history_description' => 'Der zuletzt bekannte Zustand dieses Monitorings.',
        ],
        'detail_target' => 'Ziel',
        'detail_last_check' => 'Letzter Check',
        'detail_response_time' => 'Antwortzeit',
        'detail_open_incident' => 'Incident öffnen',
        ...
        'context' => [
            'kicker' => 'Operativer Kontext',
            'heading' => 'Alles rund um das Signal',
            'open_workspace' => 'Incident-Arbeitsbereich öffnen',
            'attention_heading' => 'Braucht Aufmerksamkeit',
            'attention_description' => 'Offene Incidents und Checks, die eine Entscheidung brauchen.',
            'attention_empty' => 'Keine aktiven Aufmerksamkeitspunkte.',
            'maintenance_heading' => 'Wartungsfenster',
            'maintenance_description' => 'Bevorstehende und aktive Änderungen.',
            'maintenance_empty' => 'Keine aktiven oder bevorstehenden Wartungen.',
            'open_maintenance' => 'Wartung verwalten',
            'view_maintenance' => 'Wartung anzeigen',
            'surfaces_heading' => 'Statusflächen',
            'surfaces_description' => 'Öffentliche und interne Statusseiten.',
            'surfaces_empty' => 'Noch keine Statusseiten erstellt.',
            'open_status_pages' => 'Statusseiten verwalten',
            'delivery_warning' => ':count Benachrichtigungszustellungen sind kürzlich fehlgeschlagen.',
            'open_notifications' => 'Benachrichtigungen prüfen',
        ],
    ],
    'greeting' => 'Hi :name',
