        ...
        'sections' => [
            'scope' => [
                ...
                'items' => [
                    ...
                    'Öffentliche Status-Labels (Public Label) und einbettbares Public Widget, sofern vom Nutzer aktiviert.',
            ...
            'obligations' => [
                ...
                'items' => [
                    ...
                    'Sorgfältiger Umgang mit Zugangsdaten, API-Tokens, Heartbeat-Ping-URLs, Webhook-URLs, Bot-Tokens und optional hinterlegten Authentifizierungsdaten.',
                    ...
                    'Bei aktivierten Public Labels oder Public Widgets sicherstellen, dass keine vertraulichen Informationen in Monitoring-Namen, Zieladressen, Statusdaten oder eingebetteten Darstellungen öffentlich exponiert werden.',
                ],
            ],
            'liability' => [
