...
<div>
    ...
    <x-text-input
        id="monitoring_limit"
        type="number"
        name="monitoring_limit"
        :value="old('monitoring_limit', $package->monitoring_limit ?? '')"
        required
        autofocus
    />
...
<div class="mt-4">
    ...
    <label for="is_selectable" class="inline-flex items-center">
        ...
        />
        <span class="ms-2 text-sm text-gray-600 dark:text-gray-400">{{ __('admin.packages.fields.is_selectable') }}</span>
    </label>
