<x-app-layout>
    <x-slot name="header">
        <x-heading type="h1"> {{ __('user.title') }} </x-heading>
        ...
        <div x-data="formModalLoader()" data-form-modal-error="{{ __('app.messages.form_modal_load_error') }}">
            ...
            >
                ...
                <x-slot name="head">
                    ...
                    <x-table.heading sort="email_verified_at">
                        {{ __('user.fields.email_verification') }}</x-table.heading>
