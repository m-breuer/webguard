...
<body class="min-h-screen bg-slate-50 font-sans text-gray-900 antialiased dark:bg-slate-950 dark:text-gray-100">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <a
                    ...
                    class="flex items-center gap-2.5 rounded-md focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-hidden"
                >
                    <img
