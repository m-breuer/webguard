        ...
        <div id="incident-analytics-page-content">
            ...
            <div id="service-operations" class="space-y-6">
                    ...
                    <x-container class="overflow-hidden">
                        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                            <div class="flex items-start gap-4">
                                <span
                                    class="mt-1 inline-flex h-4 w-4 shrink-0 rounded-full {{ $healthType === 'success' ? 'bg-green-500' : ($healthType === 'danger' ? 'bg-red-500' : ($healthType === 'warning' ? 'bg-yellow-400' : 'bg-blue-500')) }}"
                                    aria-hidden="true"
                                ></span>
                                <div>
                                    <h2
                    ...
                    <x-container class="overflow-hidden lg:col-span-3" id="monitoring-groups">
                        <div class="flex items-start justify-between gap-4 border-b border-gray-200 pb-4 dark:border-gray-700">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('monitoring_group.empty.text') }}
                                </p>
                            </div>
                            <a
                                href="{{ route('monitoring-groups.index') }}"
                                class="shrink-0 text-sm font-semibold text-purple-700 hover:text-purple-900 dark:text-purple-300 dark:hover:text-purple-200"
                            >
                                    ...
                                    <div class="flex flex-col gap-4 py-4 sm:flex-row sm:items-center sm:justify-between">
                                        <div class="min-w-0">
                                            <div class="flex flex-wrap items-center gap-2">
                                                <a
                                                    href="{{ route('monitorings.index', ['group_id' => $monitoringGroup->id]) }}"
                                                    class="truncate font-semibold text-gray-900 hover:text-purple-700 dark:text-gray-100 dark:hover:text-purple-300"
                                                >
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 sm:justify-end">
                                            ...
                                            <a
                                                href="{{ route('monitorings.index', ['group_id' => $monitoringGroup->id]) }}"
                                                class="inline-flex h-10 w-10 items-center justify-center rounded-md text-purple-700 transition hover:bg-purple-50 hover:text-purple-900 focus:ring-2 focus:ring-purple-500 focus:outline-hidden dark:text-purple-300 dark:hover:bg-purple-950/40 dark:hover:text-purple-200"
                                                title="{{ __('incidents.analytics.overview.view_group') }}"
                                                aria-label="{{ __('incidents.analytics.overview.view_group') }}"
                                            >
                                    ...
                                    <div class="flex flex-col gap-3 py-4">
                                        ...
                                        <div class="flex items-center justify-between gap-3 text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            <a
                                                href="{{ route('status-pages.show', $statusPage) }}"
                                                class="inline-flex h-10 w-10 items-center justify-center rounded-md text-purple-700 transition hover:bg-purple-50 hover:text-purple-900 focus:ring-2 focus:ring-purple-500 focus:outline-hidden dark:text-purple-300 dark:hover:bg-purple-950/40 dark:hover:text-purple-200"
                                                title="{{ __('incidents.analytics.overview.view_status_page') }}"
                                                aria-label="{{ __('incidents.analytics.overview.view_status_page') }}"
                                            >
                                                <x-icon name="eye" class="h-4 w-4" />
                                            </a>
                                        </div>
                ...
                <section
                    ...
                    aria-labelledby="incident-analytics-heading"
                ...
                >
                    <x-container>
                        <div class="space-y-5">
                            <div>
                                <x-heading
                                    type="h2"
                                    id="incident-analytics-heading"
                                >{{ __('incidents.analytics.sections.recent') }}</x-heading>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('incidents.analytics.definitions') }}
                                </p>
                            </div>
                            <form
                                method="GET"
                                action="{{ route('incidents.analytics') }}"
                                class="grid w-full gap-4 sm:grid-cols-2 lg:grid-cols-[repeat(4,minmax(0,1fr))_auto]"
                            >
                                <div class="min-w-0">
                                    <x-input-label
                                        for="days"
                                        class="leading-5"
                                        :value="__('incidents.analytics.filters.period')"
                                    />
                                    <x-select-input id="days" name="days" class="mt-1 w-full">
                                        @foreach ([30, 90, 365] as $daysOption)
                                            <option
                                                value="{{ $daysOption }}"
                                                @selected($filters['days'] === $daysOption)
                                            >
                                ...
                                <div class="min-w-0">
                                    <x-input-label
                                        for="incident_type"
                                        class="leading-5"
                                        :value="__('incidents.analytics.filters.type')"
                                    />
                                    <x-select-input id="incident_type" name="incident_type" class="mt-1 w-full">
                                        ...
                                        @foreach ($incidentTypes as $type)
                                            <option
                                                value="{{ $type->value }}"
                                                @selected($filters['incident_type'] === $type->value)
                                            >
                                ...
                                <div class="min-w-0">
                                    <x-input-label
                                        for="severity"
                                        class="leading-5"
                                        :value="__('incidents.analytics.filters.severity')"
                                    />
                                    <x-select-input id="severity" name="severity" class="mt-1 w-full">
                                        ...
                                        @foreach ($severities as $severity)
                                            <option
                                                ...
                                                @selected($filters['severity'] === $severity->value)
                                            >
                                ...
                                <div class="min-w-0">
                                    <x-input-label
                                        for="customer_impact"
                                        class="leading-5"
                                        :value="__('incidents.analytics.filters.customer_impact')"
                                    />
                                    <x-select-input id="customer_impact" name="customer_impact" class="mt-1 w-full">
                                        ...
                                        @foreach ($customerImpacts as $impact)
                                            <option
                                                value="{{ $impact->value }}"
                                                @selected($filters['customer_impact'] === $impact->value)
                                            >
                                ...
                                <div class="sm:col-span-2 lg:col-span-5">
                                    <x-input-label
                                        for="affected_service"
                                        :value="__('incidents.analytics.filters.affected_service')"
                                    />
                                    <x-text-input
                                        id="affected_service"
                        ...
                        <x-container class="lg:col-span-2">
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        {{ __('incidents.analytics.filters.days_' . $filters['days']) }}
                                    </p>
                                </div>
                            ...
                            @if ($trendPoints->isEmpty() || $totalCount === 0)
                                <p class="mt-8 text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('incidents.analytics.overview.trend_empty') }}
                                </p>
                            @else
                                <div class="mt-6">
                                    <svg
                                        ...
                                        role="img"
                                        aria-label="{{ __('incidents.analytics.overview.trend') }}"
                                    >
                        ...
                        <x-container>
                            ...
                            @if ($repeatServices->isEmpty())
                                <p class="mt-6 text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('incidents.analytics.overview.recurring_empty') }}
                                </p>
                            @else
                    ...
                    <x-container>
                        ...
                        @else
                            <div class="mt-4 overflow-x-auto rounded-2xl border border-gray-200 dark:border-gray-700">
                                ...
                                >
                                    <thead>
                                        <tr class="bg-gray-50/80 text-left text-xs font-bold tracking-[0.12em] text-gray-500 uppercase dark:bg-gray-900/30 dark:text-gray-400">
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                        @foreach ($incidentPaginator as $incident)
                                            ...
                                            <tr
                                                data-incident-row
                                                class="group transition hover:bg-purple-50/50 dark:hover:bg-purple-950/20"
                                            >
                                                ...
                                                <td class="px-4 py-3">
                                                    <a
                                                        ...
                                                        class="font-bold text-gray-900 hover:text-purple-700 dark:text-gray-100 dark:hover:text-purple-300"
                                                ...
                                                <td class="px-4 py-3 whitespace-nowrap text-gray-600 dark:text-gray-300">
                                                    ...
                                                    @else
                                                        {{ __('incidents.analytics.metrics.not_available') }}
                                                    @endif
                                                </td>
                                                <td class="px-4 py-3 font-semibold whitespace-nowrap text-gray-800 dark:text-gray-200">
                                                    {{ $incidentDuration }}
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <details class="rounded-lg border border-gray-200 bg-white px-6 py-4 text-sm text-gray-600 shadow-md dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
                        <summary class="cursor-pointer font-semibold text-gray-900 dark:text-gray-100">
                            {{ __('incidents.analytics.overview.definitions_toggle') }}
                        </summary>
