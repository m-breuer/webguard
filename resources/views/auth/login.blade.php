...
<x-guest-layout card-width="sm:max-w-7xl">
    <div x-data="demoLogin(@js($initialMode))" x-init="init()" data-initial-mode="{{ $initialMode }}">
        ...
        <div class="grid gap-6 lg:grid-cols-[17rem_minmax(0,1fr)]">
            <aside class="order-2 rounded-xl border border-gray-200 bg-gray-50 p-4 lg:order-1 dark:border-gray-700 dark:bg-gray-900">
            ...
            <div class="order-1 rounded-xl border border-gray-200 bg-white p-6 shadow-xs lg:order-2 dark:border-gray-700 dark:bg-gray-800">
                <div x-show="mode === 'login' || mode === 'demo'">
                    <div class="text-center">
                        ...
                        <x-paragraph> {{ __('auth.login.description') }} </x-paragraph>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="mt-4">
                        ...
                        <div class="mt-4 flex flex-wrap items-center gap-3">
                            <x-primary-button> {{ __('auth.login.button') }} </x-primary-button>

                            @if (Route::has('password.request'))
                                <a
                                    class="rounded-md text-sm text-gray-600 underline hover:text-gray-900 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-hidden dark:text-gray-300 dark:hover:text-gray-100"
                ...
                <div x-show="mode === 'register'">
                    <div class="text-center">
                        ...
                        <x-paragraph> {{ __('auth.register.description') }} </x-paragraph>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="mt-4">
                        ...
                        <div class="mt-4">
                            <x-input-label
                                ...
                                :value="__('auth.register.confirm_password')"
                            />
                        ...
                        <div class="mt-4 space-y-3">
                            <label for="register_terms" class="inline-flex items-start">
                                <input
                                    ...
                                    type="checkbox"
                                    value="1"
                                    class="focus:ring-opacity-50 mt-0.5 rounded-sm border-gray-300 text-purple-600 shadow-xs focus:border-purple-300 focus:ring-3 focus:ring-purple-200 dark:border-gray-600"
                                    @checked(old('terms'))
                                    required
                                />
                        ...
                        <div class="mt-4" x-data="{ captchaUrl: @js(captcha_src('register')) }">
                            ...
                            <div class="mt-2 flex flex-col gap-3 sm:flex-row sm:items-center">
                                <img
                                    :src="captchaUrl"
                                    alt="{{ __('auth.register.captcha_image_alt') }}"
                                ...
                                <button
                                    ...
                                    class="rounded-md border border-gray-300 px-3 py-2 text-sm font-semibold text-gray-700 transition hover:bg-gray-100 focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-hidden dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700"
                                >
                        ...
                        <div class="mt-4 flex flex-wrap items-center gap-3">
                            <x-primary-button> {{ __('auth.register.button') }} </x-primary-button>
                        </div>
                    </form>
                </div>
