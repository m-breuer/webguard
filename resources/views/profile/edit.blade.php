        ...
        <div data-profile-settings class="grid gap-6 lg:grid-cols-[15rem_minmax(0,1fr)] lg:items-start">
            <aside class="lg:sticky lg:top-6">
                <div class="rounded-xl border border-gray-200 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <p class="px-3 py-2 text-xs font-bold tracking-[0.14em] text-gray-500 uppercase dark:text-gray-400">
                        {{ __('profile.navigation.heading') }}
                    </p>
                    <nav
                        aria-label="{{ __('profile.navigation.heading') }}"
                        class="mt-1 space-y-1 text-sm font-semibold"
                    >
                        <a
                            href="#profile-information"
                            class="block w-full rounded-lg bg-purple-50 px-3 py-2 text-purple-700 transition hover:bg-purple-100 dark:bg-purple-950/30 dark:text-purple-300 dark:hover:bg-purple-950/50"
                        >
                            {{ __('profile.navigation.account') }}
                        </a>
                        <a
                            href="#profile-password"
                            class="block w-full rounded-lg px-3 py-2 text-gray-600 transition hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700"
                        >
