...
export interface AdminActivityLog { id: string; description: string; log_name: string | null; event: string | null; subject_id: string | null; actor: string | null; created_at: string | null; }
