    ...
    public static function heartbeatCopyProvider(): array
    {
        return [
            'english' => [
                ...
                'HTTP, Ping, Keyword, Port, Heartbeat, Server Health, DNS record, SSL, and domain expiry checks with configurable alerts',
            ],
            'german' => [
                'de',
                'Heartbeat Monitoring',
                ...
                'HTTP-, Ping-, Keyword-, Port-, Heartbeat-, Server-Zustand-, DNS-Eintrags-, SSL- und Domain-Ablaufprüfungen mit konfigurierbaren Alerts',
            ],
        ];
    }
